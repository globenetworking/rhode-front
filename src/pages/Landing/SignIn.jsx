        ...
        <div className="sm:max-w-sm w-full">
          <div className="w-full rounded-lg py-0 lg:py-20 px-6 pt-4 md:pt-12 md:pt-6 bg-accent text-white shadow-xl">
            ...
            <form method="#" action="#" className="mt-6">
              ...
              <div className="mt-7">
                <span className="btn btn-secondary lg:btn-wide btn-sm h-9">Sign in</span>
              </div>
              ...
              <div className="flex mt-4 justify-center w-full">
                ...
                <div className="font-semibold text-sm lg:text-base mb-6">Don't have an account? <Link to='/sign-up' className="ml-2 text-secondary font-bold">Sign in</Link></div>
              </div>
