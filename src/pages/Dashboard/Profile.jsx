...
const Profile = () => {
  ...
  const notify = (word) => toast.info(`${word}`, {
    position: "top-right",
    autoClose: 5000,
  ...
  return (
	...
	<div class="flex flex-col ">
            ...
            <div class="mb-3 space-y-2 w-full text-base">
                  ...
                  <div class="mb-3 space-y-2 w-full text-base">
								<label class="text-sm text-gray-100 py-2  lg:text-md">Full Name</label>
								<input 
              name="name"
              onChange={onChange}
              value={newUser.name}
              ...
              class="bg-primary border border-grey-light  appearance-none block w-full bg-grey-lighter text-grey-darker  rounded-lg h-10 px-4"/>
						...
						<div class="mb-3 space-y-2 w-full text-base">
							<label class=" text-sm text-gray-100 py-2  lg:text-md">Phone number</label>
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								<input 
                 name="phone"
                 onChange={onChange}
                 value={newUser.phone}
                 type="phone" class="bg-primary flex-shrink flex-grow leading-normal w-px flex-1 border   h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder=""/>
                  </div>
                  ...
                  <div class="mt-8 text-right md:space-x-3 md:block flex flex-col-reverse">
                    <button onClick={cancel} class="mb-4 md:mb-0 bg-primary px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-100 rounded-full hover:shadow-lg hover:bg-accent">
                      {' '}
                      Cancel{' '}
                    </button>
