				...
				<div class="form">
						...
						<div class="mb-3 space-y-2 w-full text-base">
							...
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								<div class="flex">
									<span class="flex items-center leading-normal rounded-r-none border border-r-0 border-blue-300 px-3 whitespace-no-wrap text-grey-dark text-sm w-12 h-10 bg-gray-400 justify-center items-center  text-xl rounded-lg text-black">
