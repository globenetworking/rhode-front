...
const Profile = () => {
  ...
  return (
    ...
    <div className="lg:px-16 md:px-8 px-2 h-full w-[90%] mx-auto">
      ...
      <section>
        {/* <!-- component --> */}
        <div class="w-full lg:w-11/12 space-y-8 p-10 rounded-xl shadow-lg z-10 bg-accent mt-10 mb-20">
                ...
                <div class="form">
                  ...
                  <div class="mb-3 space-y-2 w-full text-base">
                    ...
                    <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                      ...
                      <input
                        type="text"
                        class="bg-primary flex-shrink flex-grow leading-normal w-px flex-1 border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow"
                        placeholder=""
                      />
                    </div>
