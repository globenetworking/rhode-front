...
const Profile = () => {
  ...
  return (
    <div className="lg:px-16 md:px-8 w-full pt-0 lg:w-11/12 lg:ml-16 px-4">
      <DashboardHeader />
			...
			<div class="mt-5">
				<div class="form">
						<div class="md:flex flex-row md:space-x-4 w-full text-xs">
							...
							<div class="mb-3 space-y-2 w-full text-xs">
								<label class="font-semibold text-gray-100 py-2">Last Miene <abbr title="required">*</abbr></label>
						...
						<div class="mb-3 space-y-2 w-full text-xs">
							...
							<div class="mb-3 space-y-2 w-full text-xs">
							<label class=" font-semibold text-gray-100 py-2">Btc address</label>
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								<div class="flex">
									<span class="flex items-center leading-normal rounded-r-none border border-r-0 border-blue-300 px-3 whitespace-no-wrap text-grey-dark text-sm w-12 h-10 bg-yellow-500 justify-center items-center  text-xl rounded-lg text-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							...
							<div class="mb-3 space-y-2 w-full text-xs">
							<label class=" font-semibold text-gray-100 py-2">Physical address</label>
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								<div class="flex">
									<span class="flex items-center leading-normal rounded-r-none border border-r-0 border-blue-300 px-3 whitespace-no-wrap text-grey-dark text-sm w-12 h-10 bg-yellow-500 justify-center items-center  text-xl rounded-lg text-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								...
								<div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
									<button class="mb-2 md:mb-0 bg-yellow-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-100 rounded-full hover:shadow-lg hover:bg-yellow-100"> Cancel </button>
