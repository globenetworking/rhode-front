...
const Profile = () => {
  ...
  return (
    <div className="lg:px-16 md:px-8 w-full pt-0 lg:w-1/2 lg:ml-16 px-4">
      ...
      <section>
      {/* <!-- component --> */}
      <div class="max-w-md w-full space-y-8 p-10 rounded-xl shadow-lg z-10 bg-accent">
<div class="grid  gap-8 grid-cols-1">
	<div class="flex flex-col ">
			<div class="flex flex-col sm:flex-row items-center">
				<h2 class="font-semibold text-lg mr-auto text-white">Shop Info</h2>
				<div class="w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0"></div>
			</div>
			<div class="mt-5">
				<div class="form">
					<div class="md:space-y-2 mb-3">
						<label class="text-xs font-semibold text-gray-100 py-2">Company Logo<abbr class="hidden" title="required">*</abbr></label>
                  ...
                  <input type="file" class="hidden bg-primary" />
                </label>
							</div>
						</div>
						<div class="md:flex flex-row md:space-x-4 w-full text-xs">
							<div class="mb-3 space-y-2 w-full text-xs">
								<label class="font-semibold text-gray-100 py-2">Company  Name <abbr title="required">*</abbr></label>
							...
							<div class="mb-3 space-y-2 w-full text-xs">
								<label class="font-semibold text-gray-100 py-2">Company  Mail <abbr title="required">*</abbr></label>
						...
						<div class="mb-3 space-y-2 w-full text-xs">
							<label class=" font-semibold text-gray-100 py-2">Company  Website</label>
							<div class="flex flex-wrap items-stretch w-full mb-4 relative">
								...
								<input type="text" class="bg-primary flex-shrink flex-grow flex-auto leading-normal w-px flex-1 border border-l-0 h-10 border-grey-light rounded-lg rounded-l-none px-3 relative focus:border-blue focus:shadow" placeholder="https://"/>
                  </div>
							</div>
							<div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
								<div class="w-full flex flex-col mb-3">
									<label class="font-semibold text-gray-100 py-2">Company Address</label>
									<input placeholder="Address" class="bg-primary appearance-none block w-full text-grey-darker  rounded-lg h-10 px-4" type="text" name="integration[street_address]" id="integration_street_address"/>
              </div>
									<div class="w-full flex flex-col mb-3">
										<label class="font-semibold text-gray-100 py-2">Location<abbr title="required">*</abbr></label>
										<select class="block w-full bg-primary text-grey-darker  rounded-lg h-10 px-4 md:w-full " required="required" name="integration[city_id]" id="integration_city_id">
                  ...
                  <option value="">Bangalore,KA</option>
								...
								<div class="flex-auto w-full mb-1 text-xs space-y-2">
									<label class="font-semibold text-gray-100 py-2">Description</label>
									<textarea required="" name="message" id="" class="bg-primary w-full min-h-[100px] max-h-[300px] h-28 appearance-none block w-full bg-grey-lighter text-grey-darker  rounded-lg  py-4 px-4" placeholder="Enter your comapny info" spellcheck="false"></textarea>
								...
								<div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
									<button class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-100 rounded-full hover:shadow-lg hover:bg-gray-100"> Cancel </button>
