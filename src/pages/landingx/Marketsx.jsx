  ...
  return (
    <div className="px-0 lg:px-0 w-full">
      <div className="drawer-content bg-white py-0 overflow-hidden ">
        ...
        <section class=" text-black px-3 md:px-24 lg:px-24">
          <div class="flex flex-col items-center text-centerw-full">
            <h1 class="text-lg text-center lg:text-3xl mb-3 mt-16 font-bold">
              A <span class="text-[#FC5C40]">Relationship</span> on your terms.
            </h1>
            <p class="pb-6 text-sm lg:text-lg text-center text-slate-400 tracking-normal lg:tracking-wider lg:w-7/12 font-normal">
        ...
        <section class="flex flex-col md:flex-row justify-around px-3">
          <div class="rounded-md shadow-md bg-[#35495D] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
            ...
            <p class="flex justify-between border-gray-200 border-b-2 ">
              <span class="font-semibold text-lg md:text-xl mt-6 tracking-wide mb-4">
                Investing
              </span>
            </p>
            <p class="mt-4 text-gray-50 tracking-wide">
              A wide selection of investment product to help build diversified
              portfolio
            </p>
          </div>
          <div class="rounded-md shadow-md bg-[#95A5A6] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
              style={{ background: "rgba(255, 255, 255, 0.3)" }}
            >
          ...
          <div class="rounded-md shadow-md bg-[#fd6a4f] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
              style={{ background: "rgba(255, 255, 255, 0.3)" }}
            >
        ...
        <section class="flex flex-col md:flex-row justify-around md:mt-6 px-3 mb-12 md:mb-24">
          <div class="rounded-md shadow-md bg-[#27BC9C] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
              style={{ background: "rgba(255, 255, 255, 0.3)" }}
            >
          ...
          <div class="rounded-md shadow-md bg-[#4284DD] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
              style={{ background: "rgba(255, 255, 255, 0.3)" }}
            >
          ...
          <div class="rounded-md shadow-md bg-[#9A5BB4] w-full md:w-96 text-white px-6 py-6 mt-3">
            <p
              class="rounded-full w-14 h-14 flex justify-center items-center bg-secondary mr-4"
              style={{ background: "rgba(255, 255, 255, 0.3)" }}
            >
