  ...
  return (
    <div class="navbar">
      ...
      <div class="navbar-end">
        <Link
          to="/user/wallet"
          class="ml-6 btn btn-sm px-2 bg-green-300 text-black hover:text-white text-xs"
        >
          connect wallet
        </Link>
      </div>
...
{
  /* <div class="navbar pr-3 px-0 lg:pr-0 py-5 bg-primary">
      <div class="navbar-start">
        <div class="dropdown">
...
//   {/* <!-- sun icon --> */}
//   <svg
//     class="swap-on fill-current w-10 h-10 bg-xyellow"
//     xmlns="http://www.w3.org/2000/svg"
//     viewBox="0 0 24 24"
//   >
...
//   {/* <!-- moon icon --> */}
//   <svg
//     class="swap-off fill-current w-10 h-10 bg-egg"
//     xmlns="http://www.w3.org/2000/svg"
//     viewBox="0 0 24 24"
//   >
